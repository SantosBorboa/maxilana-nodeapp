...
let sendemail = async function datos(nombrerecibe,celular,domicilio,colonia,codigopostal,municipio,Estado,instruccion,articulo,upc,monto,envio,total,personal,correo,sucursal, entregasucursal = false){
  ...
  if(instruccion == 'null'){
    ...
    if(entregasucursal){
      body = body + 'Tu pedido se entregar&aacute; a:</span> <br> <b> '+nombrerecibe+' <br>';
    }else{
  ...
  if(instruccion == 'null'){
    ...
    for(var i = 0; i < data.carrito.length;i++){
      ...
      for(var j =0; j < dep.productos.length;j++){
        ...
        body = body +'Sucursal: </td> ';
        body = body +'<td style="width:70%;text-align:left!important;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif">';
        body = body +''+bd.nombresucursal+'</td> ';
        body = body +'</tr>';
        body = body +'<tr> ';
        body = body +'<td style="text-align:left!important;line-height:18px;padding:0 10px 0 0;vertical-align:top;font-size:13px;font-family:Arial,sans-serif">'; 
        body = body +'Precio: </td> ';
