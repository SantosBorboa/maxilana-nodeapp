...
app.post('/api/procesar2dsecure/producto/v1',upload.array(),(req,res,next)=>{
    ...
    var ClickCollect = req.body.recogesucursal;
...
//PAGOS
app.post('/api/pagos/3dsecure/app/producto/v1',upload.array(),(req,res,next)=>{
    try{
 ...
 app.post('/api/pagos/3dsecure/app/boleta/v1',upload.array(),(req,res,next)=>{
 ...
 app.post('/api/pagos/3dsecure/web/boleta/v1',upload.array(),(req,res,next)=>{
    try{
        const Name =  req.body.nombre ? req.body.nombre : undefined;
        const LastName =  req.body.apellido ? req.body.apellido : undefined;
...
app.post('/api/pagos/3dsecure/web/productos/v1',upload.array(),(req,res,next)=>{
    try{
        ...
        //DATOS DE ENVIO
        const nombreenvio = req.body.nombreenvio;
        const celularenvio = req.body.celular;
        const domicilio = req.body.domicilio;
        const codigopostal = req.body.codigopostal;
        const colonia = req.body.colonia;
        const municipio = req.body.municipio;
...
app.post('/api/pagos/3dsecure/web/pp/v1',upload.array(),(req,res,next)=>{
   try{
    const Name =  req.body.nombre ? req.body.nombre : undefined;
    const LastName =  req.body.apellido ? req.body.apellido : undefined;
    const Email = req.body.email ? req.body.email : undefined;
 ...
 app.post('/api/pagos/3dsecure/web/vales/v1',upload.array(),(req,res,next)=>{
    ...
    const PostalCode =  req.body.cp ? req.body.cp : undefined;
    const PhoneNumber =  req.body.celular ? req.body.celular : undefined;
    const CelularEnvio =  req.body.CelularEnvio ? req.body.CelularEnvio : undefined;   
    const importe =req.body.importe;
    const titular =Name + LastName;
        ...
        libsodium.encriptar(tarjeta).then(respuesta =>{
            ...
            libsodium.encriptar(vencimiento).then(respuesta =>{
                ...
                libsodium.encriptar(ccv).then(respuesta =>{
                    ...
                    libsodium.encriptar(email).then(respuesta =>{
                        encrypCorreo = respuesta;                   
                        secureppyvales.Obteneridvalesv2(encrypTarjeta,encrypVencimiento,encrypCcv,encrypTitular,importe,cdistribuidora,encrypCorreo,celular).then(respuesta=>{
                            res.send(respuesta);
                        });
                    });
                });
